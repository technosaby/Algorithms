...
public class Percolation {
    ...
    public void open(int row, int col) {
        ...
        if (row <= 0 || col <= 0 || row > n || col > n) {
            ...
            if (!isOpen(row, col)) {
                ...
                //if (ENABLE_FAST) System.out.println("Open sites for " + cell1 + " is " + Arrays.toString(openSites));
    ...
    public boolean percolates() {
        //System.out.println("Percolates Check with " + weightedQuickUnionUF.find(oneDArraySize - 2) +
